...
const styles = StyleSheet.create({
  ...
  slide: { flex: 1, padding: 24, paddingBottom: 130 },
  stepWrap: { flex: 1 },
  stepTitle: { fontSize: 26, fontWeight: "800", color: "#01579B", marginBottom: 6, letterSpacing: 0.3 },
  stepSubtitle: { color: "#0277BD", marginBottom: 16, fontSize: 15, lineHeight: 22 },
  rowWrap: { flexDirection: "row", flexWrap: "wrap", gap: 10 },
  chip: { paddingVertical: 14, paddingHorizontal: 18, borderRadius: 16, backgroundColor: '#B3E5FC', marginBottom: 8, borderWidth: 2, borderColor: 'transparent', shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 4, elevation: 2 },
  chipSelected: { backgroundColor: '#0288D1', borderColor: '#01579B', shadowOpacity: 0.15, shadowRadius: 8, elevation: 4 },
  chipText: { color: '#01579B', fontWeight: '700', letterSpacing: 0.3, fontSize: 15 },
  chipTextSelected: { color: '#fff' },
  validation: { color: '#D32F2F', marginTop: 12, fontSize: 14, fontWeight: '600' },
  footer: { position: "absolute", bottom: 24, left: 20, right: 20, flexDirection: "row", justifyContent: "space-between", gap: 12 },
  navBtn: { flex: 1, alignItems: 'center', paddingVertical: 16, borderRadius: 14, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 6, elevation: 3 },
  navBtnText: { fontWeight: '800', letterSpacing: 0.4, fontSize: 16 },
